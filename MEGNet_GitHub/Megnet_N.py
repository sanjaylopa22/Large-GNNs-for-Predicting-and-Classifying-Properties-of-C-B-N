...
# USER CONFIG
# ===============================
CIF_DIR = "test_cif/N_materials"           # folder containing CIF files
CSV_PATH = os.path.join(CIF_DIR, "id_prop_Nitrogen.csv")  # CSV with 'id' & 'formation_energy'
OUTPUT_CSV = "megnet_results_N_test.csv"
SEED = 42
...
print("\n==========================")
print("MEGNet Nitrogen Test Results")
print("==========================")
...
plt.title("MEGNet Nitrogen Test Prediction")
plt.tight_layout()
plt.savefig("Formation_energy_comparison_MEGNet_N.png", dpi=300)
plt.show()
print("Scatter plot saved: Formation_energy_comparison_MEGNet_N.png")