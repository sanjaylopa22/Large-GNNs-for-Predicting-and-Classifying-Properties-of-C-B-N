...
DATA_FOLDER = "./examples/sample_data/N_materials"
GROUND_TRUTH_CSV = "./examples/sample_data/N_materials/id_prop_Nitrogen.csv"

OUTPUT_CSV = "alignn_predictions_Nitrogen.csv"
MERGED_CSV = "alignn_predictions_vs_gt_Nitrogen.csv"
...
if __name__ == "__main__":
    ...
    if not gt_df.empty:
        ...
        plt.legend()
        plt.savefig("scatter_plot_N_pretrained.png", dpi=300)
        plt.close()
        ...
        plt.legend()
        plt.savefig("comparison_plot_N_pretrained.png", dpi=300)
        plt.close()
