...
# Automatically append .cif extension if missing
            if file_format == "cif" and not file_path.endswith(".cif"):
                file_path = file_path + ".cif"

            if not os.path.exists(file_path):
                raise FileNotFoundError(f"Expected CIF file not found: {file_path}")
            ...
            if file_format == "poscar":
                ...
                raise NotImplementedError(f"File format not implemented: {file_format}")
