...
DATA_FOLDER = "./examples/sample_data/C_materials"
GROUND_TRUTH_CSV = "./examples/sample_data/C_materials/id_prop_Carbon.csv"
OUTPUT_CSV = "alignn_predictions_Carbon.csv"
MERGED_CSV = "alignn_predictions_vs_gt_Carbon.csv"
...
if __name__ == "__main__":
    ...
    if not gt_df.empty:
        ...
        plt.legend()
        plt.savefig("scatter_plot_C_pretrained.png", dpi=300)
        plt.close()
        ...
        plt.legend()
        plt.savefig("comparison_plot_C_pretrained.png", dpi=300)
        plt.close()
