#!/usr/bin/env python
# Domain specific Fine-tuning with deterministic 80/20 split for Boron
...
TRAIN_CIF_DIR = "./examples/sample_data/B_materials"
ID_PROP_CSV = os.path.join(TRAIN_CIF_DIR, "id_prop_Boron.csv")

OUTPUT_MODEL = "alignn_finetuned_boron.pth"

PRED_CSV = "boron_test_predictions.csv"
MERGED_CSV = "boron_predictions_vs_gt.csv"

SCATTER_PLOT = "scatter_plot_B_finetune.png"
COMPARISON_PLOT = "comparison_plot_B_finetune.png"
...
def finetune_boron():
    ...
    df = pd.DataFrame(
        {
            ...
            "predicted_energy_per_atom": y_pred,
            "formation_energy_per_atom": y_true,
        }
    )
    ...
    plt.bar(x, y_true, alpha=0.5)
    plt.bar(x, y_pred, alpha=0.5)
