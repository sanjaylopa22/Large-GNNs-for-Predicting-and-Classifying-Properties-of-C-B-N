...
# Argument Parser
# --------------------------------------------------
parser = argparse.ArgumentParser(description='CGCNN nitrogen Fine-Tuning')
...
def main():
    ...
    print("Loading dataset (Nitrogen materials)...")
    ...
    # Fine-Tuning
    # --------------------------------------------------
    print("\nStarting Fine-Tuning Nitrogen materials...")
    ...
    # Evaluation
    # --------------------------------------------------
    print("\nEvaluating on 20% TEST set (Nitrogen materials)...")
    ...
    print("\n======================================")
    print("FINAL TEST RESULTS (Nitrogen MATERIALS)")
    print("======================================")
    ...
    # Save CSV
    # --------------------------------------------------
    with open('test_results_nitrogen_materials.csv', 'w') as f:
        writer = csv.writer(f)
    ...
    plt.title("CGCNN Fine-Tuned Model (Nitrogen Materials)")
    plt.grid(True)
    plt.savefig("Nitrogen_materials_scatter.png", dpi=300)

    print("\nSaved:")
    print(" - test_results_nitrogen_materials.csv")
    print(" - nitrogen_materials_scatter.png")
